...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">atm documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/DepositCommand-1.html" data-type="entity-link" >DepositCommand</a>
                            </li>
                            <li class="link">
                                <a href="classes/WithdrawCommand.html" data-type="entity-link" >WithdrawCommand</a>
                            </li>
                            <li class="link">
                                <a href="classes/WithdrawCommand-1.html" data-type="entity-link" >WithdrawCommand</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
