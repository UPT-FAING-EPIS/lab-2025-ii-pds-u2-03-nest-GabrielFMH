...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">payment documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            ...
                            <li class="link">
                                <a href="classes/CashPaymentStrategy-1.html" data-type="entity-link" >CashPaymentStrategy</a>
                            </li>
                            <li class="link">
                                <a href="classes/CreditCardPaymentStrategy.html" data-type="entity-link" >CreditCardPaymentStrategy</a>
                            </li>
                            <li class="link">
                                <a href="classes/CreditCardPaymentStrategy-1.html" data-type="entity-link" >CreditCardPaymentStrategy</a>
                            </li>
                            <li class="link">
                                <a href="classes/DebitCardPaymentStrategy.html" data-type="entity-link" >DebitCardPaymentStrategy</a>
                            </li>
                            <li class="link">
                                <a href="classes/DebitCardPaymentStrategy-1.html" data-type="entity-link" >DebitCardPaymentStrategy</a>
                            </li>
                            <li class="link">
                                <a href="classes/PaymentContext.html" data-type="entity-link" >PaymentContext</a>
                            </li>
                            <li class="link">
                                <a href="classes/PaymentContext-1.html" data-type="entity-link" >PaymentContext</a>
                            </li>
                            <li class="link">
                                <a href="classes/PaymentService.html" data-type="entity-link" >PaymentService</a>
                            </li>
                            <li class="link">
                                <a href="classes/PaymentService-1.html" data-type="entity-link" >PaymentService</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
